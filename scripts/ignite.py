...
_TOURNAMENT_STAKES_SUFFIX = (
    ...
    "名义到净值100%,全组合总名义敞口没有上限(2026-07-18起用户撤销了300%"
    "总敞口限制)——总敞口长期连净值的100%都不到,意味着连1倍杠杆都不敢"
    "用满,数学上注定跑不出有意义"
...
_BRAIN_DERBY_STAKES_SUFFIX = (
    ...
    "本金只有100U,系统允许单仓名义到净值100%,全组合总名义敞口没有上限"
    "(唯一的天花板是每个标的各自100%的单仓上限和爆仓线本身)——总敞口"
    "长期连净值的100%都不到,意味着连1倍杠杆都"
